...
from utils.utils import ImageFolderDataset, calc_mean_std, get_transform, adaptive_instance_normalization
...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default=r"C:\Users\Sujal  Jethwa\NeuralArt\content_data",
                        help='Location of the content dataset')
    
    parser.add_argument('--style_dir', type=str, default=r"C:\Users\Sujal  Jethwa\NeuralArt\style_data",
                        help='Location of style data')
    
    parser.add_argument('--vgg', type=str, default=r"C:\Users\Sujal  Jethwa\NeuralArt\vgg_normalised.pth",
